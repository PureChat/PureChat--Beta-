...
class LoginRegister extends PureChat
{
	...
	public function content()
	{
		...
		echo '
			<div class="content">
				<h3 class="page_title">', PureChat::$lang['register_form'], '</h3>
				<h5 class="page_description">', PureChat::$lang['registration_caption'], '</h5>
		...
		if (!empty(PureChat::$globals['registration_errors']))
		{
			echo '
				<div class="error">
					', PureChat::$lang['the_bad_news'], '
					<ul>';
					foreach (PureChat::$globals['registration_errors'] as $er => $true)
					{
						echo '<li>', isset(PureChat::$lang[$er]) ? PureChat::$lang[$er] : PureChat::$lang['registration_errors_not_found'], '</li>';
					}
					echo '</ul>
				</div>
			';
		...
		elseif (isset($_GET['success']))
			echo '<div class="success">', PureChat::$lang['account_registered'], '</div>';
		...
		echo '
						<div class="form_information">
							...
							<label class="form_label" for="registration_username">', PureChat::$lang['display_name'], '</label>
							<span class="form_desc">', PureChat::$lang['display_name_desc'], '</span>
							<hr />
						</div>

						<div class="form_information">
							<input class="form_input" type="text" name="email" id="registration_email"', !empty($_POST['email']) ? ' value="' . $_POST['email'] . '"' : '', ' />
							<label class="form_label" for="registration_username">', PureChat::$lang['email'], '</label>
							<span class="form_desc">', PureChat::$lang['email_desc'], '</span>
							<hr />
						</div>

						<div class="form_information">
							<input class="form_input" type="password" name="password" id="registration_password" />
							<label class="form_label" for="registration_username">', PureChat::$lang['password'], '</label>
							<span class="form_desc">', PureChat::$lang['password_desc'], '</span>
							<hr />
						</div>

						<div class="form_information">
							<input class="form_input" type="password" name="password2" id="registration_password2" />
							<label class="form_label" for="registration_username">', PureChat::$lang['password_again'], '</label>
							<span class="form_desc">', PureChat::$lang['password2_desc'], '</span>
							<hr />
						</div>

						<div class="form_information">
							', !isset($_SESSION['no_bot']) ? '
								<input class="form_button" id="next1" type="button" value="' . PureChat::$lang['next'] . '" />' : '
								<input class="form_button" type="submit" value="' . PureChat::$lang['register'] . '" />'
							, '
						</div>
					</div>';
			...
			echo '
					<div id="user_verification">
						...
						<div class="form_information" id="submission">
							<input class="form_button" type="submit" id="registration_submit" value="', PureChat::$lang['register'], '" disabled />
							<input id="back1" class="form_button" type="button" value="', PureChat::$lang['back'], '" />
							<span class="noblock form_desc"><em>', PureChat::$lang['mini_agreement'], '</em></span>
						</div>
					</div>
			';
